  ...
  if (_scalars_) {
    ...
    if (pba->use_prtoe == _TRUE_) {
        ...
        if (prtoe_active == _TRUE_) {
            ...
            /* Inactive / Null limit: Freeze perturbations */
